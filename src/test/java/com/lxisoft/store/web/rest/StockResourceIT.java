...
public class StockResourceIT {
    ...
    private static final Long DEFAULT_NO_OF_ITEM = 1L;
    private static final Long UPDATED_NO_OF_ITEM = 2L;
    ...
    public void createStock() throws Exception {
        ...
        assertThat(testStock.getNoOfItem()).isEqualTo(DEFAULT_NO_OF_ITEM);
    }
    ...
    public void updateStock() throws Exception {
        ...
        assertThat(testStock.getNoOfItem()).isEqualTo(UPDATED_NO_OF_ITEM);
    }
