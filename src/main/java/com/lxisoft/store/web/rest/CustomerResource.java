...
/**
 * REST controller for managing {@link com.lxisoft.store.domain.Customer}.
 */
@RestController
@RequestMapping("/api")
public class CustomerResource {
    ...
    public List<CustomerDTO> getAllCustomers(@RequestParam(required = false) String filter) {
        if ("sale-is-null".equals(filter)) {
            log.debug("REST request to get all Customers where sale is null");
            return customerService.findAllWhereSaleIsNull();
        }
